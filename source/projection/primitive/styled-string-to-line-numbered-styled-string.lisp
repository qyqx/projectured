  ...
  (bind ((typed-input-reference `(the ,(form-type input) ,input-reference))
         ...
         (output (labels ((write-element (element)
                   ...
                   (iter (with format-string = (format nil "\~~~A,' D " line-number-length))
                         ...
                         (for line :in (text/split input #\NewLine))
                         ...
                         (iter (for line-element :in-sequence (elements-of line))
                               (typecase line-element
                                 (text/string
                                  ...
                                  (push (make-iomap/string line-content `(content-of (the text/string (elt (the list (elements-of ,typed-input-reference)) ,input-index))) 0
